...
from PyQt5.QtWidgets import (
    ...
    QDialog,  # Added for details dialog
...
def get_database_path():
    if getattr(sys, 'frozen', False):
        ...
        # Copy database to the executable's directory if it doesn't exist
...
class CommTrackerApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.import_button = QPushButton("Import CSV")  # <-- NEW

        self.import_button.clicked.connect(self.import_csv)  # <-- NEW
        ...
        button_layout.addWidget(self.export_button)  # <-- NEW
